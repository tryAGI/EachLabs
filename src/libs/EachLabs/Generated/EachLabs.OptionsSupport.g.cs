...
namespace EachLabs
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::EachLabs.AutoSDKRetryOptions Retry { get; set; } = new global::EachLabs.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::EachLabs.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::EachLabs.IAutoSDKHook>();
        ...
        public global::EachLabs.AutoSDKClientOptions AddHook(
            global::EachLabs.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::EachLabs.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::EachLabs.AutoSDKClientOptions UseAuthorizationProvider(
            global::EachLabs.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::EachLabs.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::EachLabs.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::EachLabs.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::EachLabs.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::EachLabs.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::EachLabs.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::EachLabs.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::EachLabs.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::EachLabs.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::EachLabs.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::EachLabs.AutoSDKRetryOptions? Retry { get; set; }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::EachLabs.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::EachLabs.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::EachLabs.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::EachLabs.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::EachLabs.AutoSDKClientOptions clientOptions,
            global::EachLabs.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::EachLabs.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::EachLabs.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::EachLabs.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::EachLabs.AutoSDKClientOptions clientOptions,
            global::System.Func<global::EachLabs.IAutoSDKHook, global::EachLabs.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::EachLabs.AutoSDKHookContext context)
        {
