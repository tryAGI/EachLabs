...
namespace EachLabs
{
    public partial class AiModelsPredictionClient
    {
        ...
        private static readonly global::EachLabs.EndPointSecurityRequirement s_GetPredictionSecurityRequirement0 =
        ...
        private static readonly global::EachLabs.EndPointSecurityRequirement[] s_GetPredictionSecurityRequirements =
            new global::EachLabs.EndPointSecurityRequirement[]
            {                s_GetPredictionSecurityRequirement0,
            };
        partial void PrepareGetPredictionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareGetPredictionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessGetPredictionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetPredictionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EachLabs.Prediction> GetPredictionAsync(
            string id,
            global::EachLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetPredictionAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EachLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EachLabs.AutoSDKHttpResponse<global::EachLabs.Prediction>> GetPredictionAsResponseAsync(
            string id,
            global::EachLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::EachLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetPredictionSecurityRequirements,
                operationName: "GetPredictionAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::EachLabs.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::EachLabs.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetPredictionAsync",
                                pathTemplate: "$\"/v1/prediction/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::EachLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::EachLabs.Error? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::EachLabs.Error.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::EachLabs.ApiException<global::EachLabs.Error>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetPredictionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EachLabs.Prediction.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EachLabs.AutoSDKHttpResponse<global::EachLabs.Prediction>(
                                        statusCode: __response.StatusCode,
                                ...
                                {
                                    throw new global::EachLabs.ApiException(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EachLabs.Prediction.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
