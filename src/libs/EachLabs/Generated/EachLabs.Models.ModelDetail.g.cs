...
namespace EachLabs
{
    ...
    public sealed partial class ModelDetail
    {
        ...
        /// </summary>
        /// <example>{"type":"object","required":["prompt"],"properties":{"prompt":{"type":"string","minLength":10,"maxLength":500}}}</example>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelDetail" /> class.
        /// </summary>
        /// <param name="title">
        /// Example: Nano Banana Pro Edit
        /// </param>
