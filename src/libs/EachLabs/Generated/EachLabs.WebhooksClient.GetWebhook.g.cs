                    ...
                    await global::EachLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::EachLabs.WebhookWithAttempts.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::EachLabs.WebhookWithAttempts.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
