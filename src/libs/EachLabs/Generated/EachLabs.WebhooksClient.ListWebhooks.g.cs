...
namespace EachLabs
{
    public partial class WebhooksClient
    {
        ...
        private static readonly global::EachLabs.EndPointSecurityRequirement s_ListWebhooksSecurityRequirement0 =
        ...
        private static readonly global::EachLabs.EndPointSecurityRequirement[] s_ListWebhooksSecurityRequirements =
            new global::EachLabs.EndPointSecurityRequirement[]
            {                s_ListWebhooksSecurityRequirement0,
            };
        partial void PrepareListWebhooksArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref int? offset);
        partial void PrepareListWebhooksRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            int? offset);
        partial void ProcessListWebhooksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListWebhooksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::EachLabs.ListWebhooksResponse> ListWebhooksAsync(
            int? limit = default,
            int? offset = default,
            global::EachLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListWebhooksAsResponseAsync(
                limit: limit,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::EachLabs.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::EachLabs.AutoSDKHttpResponse<global::EachLabs.ListWebhooksResponse>> ListWebhooksAsResponseAsync(
            int? limit = default,
            int? offset = default,
            global::EachLabs.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::EachLabs.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListWebhooksSecurityRequirements,
                operationName: "ListWebhooksAsync");
                ...
                else
                {
                    await global::EachLabs.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::EachLabs.Error? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::EachLabs.Error.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListWebhooksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::EachLabs.ListWebhooksResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::EachLabs.AutoSDKHttpResponse<global::EachLabs.ListWebhooksResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::EachLabs.ListWebhooksResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
