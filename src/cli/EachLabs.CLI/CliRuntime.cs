...
namespace EachLabs.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "EachLabs.CLI";
    private const string UserSecretApiKeyName = "EACHLABS_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"EACHLABS_API_KEY"];
    private const string CredentialFileDirectoryName = ".each-labs";

    public static async global::System.Threading.Tasks.Task<global::EachLabs.EachLabsClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::EachLabs.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::EachLabs.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::EachLabs.EachLabsClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::EachLabs.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::EachLabs.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::EachLabs.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::EachLabs.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("EACHLABS_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::EachLabs.ApiException exception)
    {
        var builder = new StringBuilder();
