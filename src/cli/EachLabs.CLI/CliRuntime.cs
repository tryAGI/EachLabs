...
internal static class CliRuntime
{
    ...
    public static async Task<global::EachLabs.EachLabsClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::EachLabs.ApiException exception)
    {
        var builder = new StringBuilder();
